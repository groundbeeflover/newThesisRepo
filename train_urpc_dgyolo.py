...
class DGYOLO(LightningModule):
    def __init__(self,n_classes, batch_size, exp, reg_weights):
        ...
        self.detector = Darknet('./config/yolov3-custom-640-urpc.cfg')        
    ...
    def configure_optimizers(self):
      ...
      optimizer = torch.optim.Adam([{'params': self.detector.parameters(), 'lr': self.base_lr},])
...
def parser_args():
  parser = argparse.ArgumentParser(description='DGYOLO URPC Experiments')
...
if __name__ == '__main__':
  ...
  if 'o' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_train_real.csv', root='data/', transform=train_transform, domain=domain_index))
  if '1' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_1.csv', root='data/', transform=train_transform, domain=domain_index))
  if '2' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_2.csv', root='data/', transform=train_transform, domain=domain_index))
  if '3' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_3.csv', root='data/', transform=train_transform, domain=domain_index))
  if '4' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_4.csv', root='data/', transform=train_transform, domain=domain_index))
  if '5' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_5.csv', root='data/', transform=train_transform, domain=domain_index))
  if '6' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_6.csv', root='data/', transform=train_transform, domain=domain_index))
  if '7' in args.source_domains.lower():
    domain_index = domain_index + 1
    tr_datasets.append(DrivingDataset('data/Annots/urpc_trainsyn_domain_7.csv', root='data/', transform=train_transform, domain=domain_index))
  ...
  if 'o' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_val_real.csv', root='data/', transform=val_transform, domain=domain_index))
  if '1' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_1.csv', root='data/', transform=val_transform, domain=domain_index))
  if '2' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_2.csv', root='data/', transform=val_transform, domain=domain_index))
  if '3' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_3.csv', root='data/', transform=val_transform, domain=domain_index))
  if '4' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_4.csv', root='data/', transform=val_transform, domain=domain_index))
  if '5' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_5.csv', root='data/', transform=val_transform, domain=domain_index))
  if '6' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_6.csv', root='data/', transform=val_transform, domain=domain_index))
  if '7' in args.source_domains.lower():
    domain_index = domain_index + 1
    vl_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_7.csv', root='data/', transform=val_transform, domain=domain_index))
  ...
  test_datasets = []
  domain_index = -1
  if 'o' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_val_real.csv', root='data/', transform=val_transform, domain=domain_index))
  if '1' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_1.csv', root='data/', transform=val_transform, domain=domain_index))
  if '2' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_2.csv', root='data/', transform=val_transform, domain=domain_index))
  if '3' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_3.csv', root='data/', transform=val_transform, domain=domain_index))
  if '4' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_4.csv', root='data/', transform=val_transform, domain=domain_index))
  if '5' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_5.csv', root='data/', transform=val_transform, domain=domain_index))
  if '6' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_6.csv', root='data/', transform=val_transform, domain=domain_index))
  if '7' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_7.csv', root='data/', transform=val_transform, domain=domain_index))
  if '8' in args.target_domains.lower():
    domain_index = domain_index + 1
    test_datasets.append(DrivingDataset('data/Annots/urpc_valsyn_domain_8.csv', root='data/', transform=val_transform, domain=domain_index))
  ...
  detector = DGYOLO(6, 8, args.exp, args.reg_weights) # Num classes + 1 and batch_size
  ...
  trainer = Trainer(accelerator="gpu", max_epochs=300, deterministic=False, callbacks=[checkpoint_callback], num_sanity_val_steps=2, gradient_clip_val=2)
